...
urlpatterns = [
    ...
    url(r'^sponsors/$',views.sponsor,name='sponsor'),
    ...
    url(r'sign_in/$', vw.sign_in, name='sign_in'),
    url(r'sign_up/$', vw.sign_up, name='sign_up'),
    url(r'sign_out/$', vw.sign_out, name='sign_out'),
    url(r'dashboard/$', vw.interface,name='interface'),
